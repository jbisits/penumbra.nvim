...
hl.common = {
  ...
  DiffDelete = { fg = c.none, bg = util.lighten(c.red, 0.25, c.bg) },
  DiffText = { fg = c.none, bg = util.lighten(c.cyan, 0.25, c.bg) },
  ...
  StatusLineNC = { fg = c.fg_m, bg = c.bg_p },
  StatusLineTermNC = { fg = c.fg_m, bg = c.bg_p },
  TabLine = { fg = c.fg, bg = c.bg_p },
  TabLineFill = { fg = c.sky_m, bg = c.bg_p },
  TabLineSel = { fg = c.bg, bg = c.fg },
  WinSeparator = { bg = c.bg, fg = c.fg },
  Visual = { bg = c.bg_p },
...
if vim.api.nvim_call_function('has', { 'nvim-0.8' }) == 1 then
  hl.treesitter = {
    ...
    ['@constant.macro'] = { fg = c.cyan, fmt = cfg.code_style.constants },
    ...
    ['@markup.link.url'] = { fg = c.red, fmt = 'underline' },
    ['@markup.list'] = colors.Red,
    ['@markup.math'] = colors.Fg,
    ['@markup.quote'] = c.purple_c,
    ['@markup.raw'] = colors.Green,
    ['@markup.strike'] = { fg = c.fg_m, fmt = 'strikethrough' },
    ...
    ['@markup.heading.2.markdown'] = { fg = c.yellow, fmt = 'bold' },
    ['@markup.heading.3.markdown'] = { fg = c.red, fmt = 'bold' },
    ['@markup.heading.4.markdown'] = { fg = c.purple_c, fmt = 'bold' },
    ['@markup.heading.5.markdown'] = { fg = c.purple, fmt = 'bold' },
    ['@markup.heading.6.markdown'] = { fg = c.blue, fmt = 'bold' },
    ['@markup.heading.1.marker.markdown'] = { fg = c.orange, fmt = 'bold' },
    ['@markup.heading.2.marker.markdown'] = { fg = c.yellow, fmt = 'bold' },
    ['@markup.heading.3.marker.markdown'] = { fg = c.red, fmt = 'bold' },
    ['@markup.heading.4.marker.markdown'] = { fg = c.purple_c, fmt = 'bold' },
    ['@markup.heading.5.marker.markdown'] = { fg = c.purple, fmt = 'bold' },
    ['@markup.heading.6.marker.markdown'] = { fg = c.blue, fmt = 'bold' },
  ...
  hl.treesitter = {
    ...
    TSNote = colors.Fg,
    TSWarning = colors.Red,
    TSDanger = colors.Red,
    TSType = { fg = c.yellow, fmt = 'bold' },
...
hl.plugins.nvim_tree = {
  ...
  NvimTreeGitStagedIcon = colors.Yellow,
  NvimTreeGitMergededIcon = colors.Cyan,
  NvimTreeGitNewIcon = colors.Green,
  NvimTreeGitDeletedIcon = colors.Red,
...
hl.plugins.telescope = {
  ...
  TelescopeMatching = { fg = c.purple_c, fmt = 'bold' },
...
hl.plugins.snacks = {
  ...
  -- indent
  SnacksIndentScope = {c.purple_c, link = 'Normal'},
  SnacksIndentChunk = {c.purple_c, link = 'Normal'},
...
hl.plugins.notify = {
  NotifyERRORBorder = { bg = c.bg, fg = c.red },
  NotifyWARNBorder = { bg = c.bg, fg = c.orange },
  NotifyINFOBorder = { bg = c.bg, fg = c.blue },
  NotifyDEBUGBorder = { bg = c.bg, fg = c.purple },
  NotifyTRACEBorder = { bg = c.bg, fg = c.purple },
  NotifyERRORIcon = { bg = c.bg, fg = c.red },
  NotifyWARNIcon = { bg = c.bg, fg = c.orange },
  NotifyINFOIcon = { bg = c.bg, fg = c.blue },
  NotifyDEBUGIcon = { bg = c.bg, fg = c.purple },
  NotifyTRACEIcon = { bg = c.bg, fg = c.purple },
  NotifyERRORTitle = { bg = c.bg, fg = c.red },
  NotifyWARNTitle = { bg = c.bg, fg = c.orange },
  NotifyINFOTitle = { bg = c.bg, fg = c.blue },
  NotifyDEBUGTitle = { bg = c.bg, fg = c.purple },
  NotifyTRACETitle = { bg = c.bg, fg = c.purple },
  NotifyERRORBody = { bg = c.bg, fg = c.fg },
  NotifyWARNBody = { bg = c.bg, fg = c.fg },
  NotifyINFOBody = { bg = c.bg, fg = c.fg },
  NotifyDEBUGBody = { bg = c.bg, fg = c.fg },
  NotifyTRACEBody = { bg = c.bg, fg = c.fg },
}

hl.plugins.render_markdown = {
  RenderMarkdownH1Bg = { fg = c.none, bg = util.lighten(c.orange, 0.25, c.bg) },
  RenderMarkdownH2Bg = { fg = c.none, bg = util.lighten(c.yellow, 0.25, c.bg) },
  RenderMarkdownH3Bg = { fg = c.none, bg = util.lighten(c.red, 0.25, c.bg) },
  RenderMarkdownH4Bg = { fg = c.none, bg = util.lighten(c.purple_c, 0.25, c.bg) },
  RenderMarkdownH5Bg = { fg = c.none, bg = util.lighten(c.purple, 0.25, c.bg) },
  RenderMarkdownH6Bg = { fg = c.none, bg = util.lighten(c.blue, 0.25, c.bg) },
}
...
hl.langs.markdown = {
  ...
  markdownH3 = { fg = c.red, fmt = 'bold' },
  markdownH4 = { fg = c.purple_c, fmt = 'bold' },
  markdownH5 = { fg = c.purple, fmt = 'bold' },
  markdownH6 = { fg = c.blue, fmt = 'bold' },
