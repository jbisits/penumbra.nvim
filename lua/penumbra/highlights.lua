...
hl.common = {
	...
	DiffAdd = { fg = c.none, bg = cfg.transparent and c.bg_green },
	DiffChange = { fg = c.none, bg = cfg.transparent and c.bg_blue },
	DiffDelete = { fg = c.none, bg = cfg.transparent and c.bg_red },
	DiffText = { fg = c.none, bg = cfg.transparent and c.bg_cyan },
