...
hl.common = {
	...
	DiffAdd = { fg = c.none, bg = util.lighten(c.green, 0.75, c.bg) },
	DiffChange = { fg = c.none, bg = util.lighten(c.blue, 0.75, c.bg) },
	DiffDelete = { fg = c.none, bg = util.lighten(c.red, 0.75, c.bg) },
	DiffText = { fg = c.none, bg = util.lighten(c.cyan, 0.75, c.bg) },
