...
hl.plugins.notify = {
	...
	NotifyINFOBorder = { bg = c.bg, fg = c.cyan },
	...
	NotifyINFOIcon = { bg = c.bg, fg = c.cyan },
	...
	NotifyINFOTitle = { bg = c.bg, fg = c.cyan },
...
hl.plugins.render_markdown = {
	...
	RenderMarkdownH4Bg = { fg = c.none, bg = util.lighten(c.magenta, 0.25, c.bg) },
